...
const statusMap: Record<string, { className: string; label: string }> = {
    ...
    FIRING: { className: 'bg-danger/15 text-danger', label: 'Firing' },
    ACKNOWLEDGED: { className: 'bg-primary/15 text-primary', label: 'Acknowledged' },
    RESOLVED: { className: 'bg-success/15 text-success', label: 'Resolved' },
    ...
    DEAD_LETTER: { className: 'bg-danger/15 text-danger', label: 'Dead letter' },
    CANCELLED: { className: 'bg-default text-muted', label: 'Cancelled' },
    SUCCEEDED: { className: 'bg-success/15 text-success', label: 'Succeeded' },
