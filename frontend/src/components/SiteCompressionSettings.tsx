...
export function SiteCompressionSettings({
    ...
    return (
        <div className='space-y-8'>
                            ...
                            <div className='grid gap-4 sm:grid-cols-2'>
                                ...
                                <FormField
                                    ...
                                    error={
                                        limitsValid
                                            ? undefined
                                            : 'Maximum must be at least the minimum and no more than 64 MB.'
                                    }
                                >
                                    <ByteSizeInput
                            ...
                            <div className='flex items-center justify-between gap-5 rounded-xl border border-border/70 bg-surface-secondary/20 px-4 py-3.5'>
                                <div>
                                    ...
                                    <div className='mt-0.5 text-xs leading-5 text-muted'>
                                        Decode supported origin encodings and apply a
                                        higher-priority algorithm accepted by the client.
                                    </div>
                                </div>
                                <ToggleSwitch
                                    ...
                                    onChange={(recompress) =>
                                        onChange({ ...compression, recompress })
                                    }
                                />
                            </div>
                        </Section>
            ...
            <SettingsActionBar isDirty={isDirty} isDiscardDisabled={saving} onDiscard={onDiscard}>
                <Button
                    isDisabled={saving || (compression.enabled && (!limitsValid || !matchersValid))}
                    onPress={onSave}
                >
