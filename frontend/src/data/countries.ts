import type { MultiAddOption } from '@/components/SearchableMultiAddField.tsx';
...
export const countryOptions: MultiAddOption[] = countryCodes.map((code) => ({
    id: code,
