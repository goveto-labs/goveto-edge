...
func govetoCacheHandler(siteID string, cachePolicy cachepolicy.CachePolicy, rule cachepolicy.CacheRule, nodeConfig NodeConfig) map[string]any {
	return map[string]any{
		...
		"key_query_normalize":        cachePolicy.CacheKey.Query.NormalizeEnabled(),
		"key_query_include":          cachePolicy.CacheKey.Query.Include,
		"key_query_exclude":          cachePolicy.CacheKey.Query.Exclude,
		"key_cookies":                cachePolicy.CacheKey.Cookies,
